...
class NotificationService {
  ...
  Future<void> scheduleNotificationsBasedOnMedicine() async {
    ...
    QuerySnapshot querySnapshot = await _firestore.collection('users').doc(firebaseUser!.uid).collection('medicine').get();
      ...
      for (var reminderTimestamp in medicine.reminderTime) {
        ...
        await AwesomeNotifications().createNotification(
          content: NotificationContent(
            ...
            title: "Its time to take your medicine ", // Title for the notification.
            body:
                '${medicine.dosage} ${medicine.name} .', // Body text for the notification.
          ),
